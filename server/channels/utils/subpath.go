...
func UpdateAssetsSubpathInDir(subpath, directory string) error {
	...
	reCSP := regexp.MustCompile(`<meta http-equiv="Content-Security-Policy" content="script-src 'self' blob: cdn.rudderlabs.com/ js.stripe.com/v3 'unsafe-eval'; worker-src 'self' blob:">`)
	...
	newRootHTML = reCSP.ReplaceAllLiteralString(newRootHTML, fmt.Sprintf(
		`<meta http-equiv="Content-Security-Policy" content="script-src 'self' blob: cdn.rudderlabs.com/ js.stripe.com/v3 'unsafe-eval'; worker-src 'self' blob:">`,
